...
export default function Cart() {
  ...
  return (
    ...
    <div className="divCart">
      <Typography  style={{color:'#ffff', textAlign:'center', margin:'2rem'}} variant="h4"> Carrito </Typography>
      ...
      >
        ...
        <div className="divFinalizarCompra">
          ...
          <Stack spacing={2} direction="row">
            <Button variant="contained" component={Link} to={"/checkout"}>Finalizar compra</Button>
